...
Summary: legacypython components for the iso8601 package.
Group: Default
Requires: python-core

%description legacypython
legacypython components for the iso8601 package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1507155419
